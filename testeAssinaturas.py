...
if __name__ == "__main__":
    ...
    print("Gerando persistências da dados de urnas")
    for x in tqdm(range(int(sys.argv[1]))):
        ...
        urnas.append({"urnaID": urnaID, "saldo": saldo, "chavePrivada": chavePrivada.to_string().hex(), "chavePublica": chavePublica, "assinatura": assinatura})
